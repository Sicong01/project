package com.ascending3.learnrestapi3.util;
...
*/
    public static final String HQL_SELECT_ALL_COACHES = "From Coach";

/*
    public static final String HQL_SELECT_MAJOR_BY_ID = "FROM Major as m where m.id = :id";
*/

    public static final String HQL_SELECT_COACH_BY_ID = "FROM Coach as c where c.id = :id";
    ...
    public static final String HQL_SELECT_ALL_COACHES_WITH_CHILDREN = "SELECT distinct c FROM Coach as c " +
            "left join fetch c.members as member left join fetch member.courses";
...
/*    public static final String HQL_SELECT_MAJOR_WITH_CHILDREN_BY_MAJOR_ID = "SELECT distinct m FROM Major as m " +
    ...
    public static final String HQL_SELECT_COACH_WITH_CHILDREN_BY_COACH_ID = "SELECT distinct c FROM Coach as c " +
        "left join fetch c.members as member left join fetch member.courses where c.id = :id";
