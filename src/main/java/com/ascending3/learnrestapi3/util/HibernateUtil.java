...
public class HibernateUtil {
    ...
    private static SessionFactory loadSessionFatory() {
        ...
        String[] modelPackages = {"com.ascending3.learnrestapi3.entity"};
        //String[] testPackages = {"com.ascending3.learnrestapi3.entity"};
...
//        String dbPassword = System.getProperty("database.password");
        ...
        configuration.addAnnotatedClass(com.ascending3.learnrestapi3.entity.Coach.class);
        configuration.addAnnotatedClass(com.ascending3.learnrestapi3.entity.Course.class);
        configuration.addAnnotatedClass(com.ascending3.learnrestapi3.entity.Member.class);
